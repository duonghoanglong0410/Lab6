...
class AntiVirusApp(tk.Tk):
    def __init__(self):
        ...
        subtitle_label = tk.Label(self.main_content,
                                  text="Premium will be free forever. You just need to click button.", bg="white")
        ...
        for i, button in enumerate(buttons):
            tk.Button(buttons_frame, text=button, bg="#FF00FF", fg="white", font=("Arial", 14), width=15).grid(
                row=i // 2, column=i % 2, padx=10, pady=5)

        premium_label = tk.Label(self.main_content,
                                 text="Get Premium to Enable: {Web Protection}, {Full Scan}, {Simple Update}",
                                 bg="white", fg="#FF00FF", font=("Arial", 12))
